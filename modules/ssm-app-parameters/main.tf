...
# ============================================================================
# Web runtime parameters (SSR) - OBSOLETE: NextAuth not used in new architecture
# ============================================================================
# NOTE: The new kambriq-web repository does NOT use NextAuth.
# Authentication is handled via JWT with HttpOnly cookies from the API.
# These resources are kept for backward compatibility but are not used.
# ============================================================================

# NextAuth resources removed - not used in new architecture
# The new kambriq-web repository uses JWT authentication via the API
# No NextAuth secrets are needed
